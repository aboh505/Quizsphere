...
export default function Home() {
  return (
    <main className="w-full overflow-x-hidden">
      {/* HERO SECTION */}
      <section className="relative bg-color-green-500 text-white h-screen flex items-center justify-center">
        <Image
          src="/hero.jpg" // mets ton image dans /public/hero-bg.jpg
          alt="Hero Background"
          fill
          className="object-cover absolute inset-0 -z-5 brightness-75"
        />
        <motion.div
